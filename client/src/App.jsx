    ...
    <div className='w-screen h-screen bg-gray-900 text-white flex flex-col justify-center items-center'>
      {chatActive ? (
        <div className='w-full h-full flex flex-col'>
          <div className='bg-black-900 round-t-md'>
            ...
            {messgaes.map((message, index) => (
              ...
              >
                <div
                  ...
                  }-500 text-white rounded-full h-8 w-8 flex items-center justify-center mr-2`}
                >
                ...
                <div
                  className={`bg-${
                    message.user === username ? '' : 'blue'
                  }-700 text-xs rounded-lg p-2 text-white ${
                    message.user === username ? 'self-end' : 'self-start'
                  }`}
                >
          ...
          <form className='p-4 bg-gray-800 rounded-b-md flex'>
            <input
              type='text'
            ...
            <button
              type='Submit'
              className='bg-blue-500 text-white p-4 py-2 rounded-md font-bold ml-3'
        ...
        <div className='flex flex-col gap-2'>
          <input
            ...
            className='border-2 rounded-sm px-3 py-2 outline-none bg-black-700 text-black'
            value={username}
